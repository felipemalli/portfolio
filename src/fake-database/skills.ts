...
const frontendSkills: string[] = ['HTML', 'CSS', 'Javascript', 'Typescript', 'React', 'Redux', 'Next', 'Jest', 'Tailwind', 'Material-UI', 'Figma']

const otherSkills: string[] = ['Design Patterns, OOP, Microservices, Clean Architecture']


export { frontendSkills, backendSkills, devopsSkills, otherSkills }
