...
export const courses: ICard[] = [
  {
    ...
    inProgress: false,
    image: 'microservices_stephengrinder',
    techAreas: {
      frontend:{
  ...
  },
  {
    ...
    inProgress: false,
    image: 'javabootcamp_trybeandwipro',
    techAreas: {
      backend: {
  ...
  },
  {
    ...
    inProgress: true,
    image: 'cleanarchitecture_rodrigomanguinho',
    techAreas: {
      backend: {
