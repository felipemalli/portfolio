...
export const LanguageButton: React.FC<ILanguageButtonProps> = ({ className, hasText, setIsRenderLanguage }: ILanguageButtonProps) => {
  ...
  return (
    <div ref={languageRef} className={`${className} scale-90`}>
      <button className={`flex h-10 items-center ${hasText ? 'justify-end' : 'justify-center'} space-x-[5px] xl:w-full w-10 h-10 hover:bg-customGray-200 xl:p-2 rounded-full -ml-2 xl:ml-0`}
