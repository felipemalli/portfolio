...
export const CourseArea: React.FC = () => {
  ...
  const scrollLeft = () => {
    if (buttonClickable) {
      const slider = document.getElementById('course-content');
      if (slider) {
  ...
  return (
    <div className='flex flex-col justify-evenly items-center h-[26rem] m-auto md:rounded-b-[5rem] border border-[#737E86] bg-[#fbfbfb]'>
      <div className={'flex justify-center items-center gap-[0.938rem] mt-1'}>
