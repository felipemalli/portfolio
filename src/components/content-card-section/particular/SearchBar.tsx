...
export const SearchBar: React.FC = () => {
  ...
  return (
    <div className='flex items-center bg-secondary-500 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 sm:w-72 h-9 rounded-full p-0.5 shadow-md hover:shadow-lg transition-shadow duration-100'>
