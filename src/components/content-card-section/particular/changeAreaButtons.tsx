...
export const ChangeAreaButtons: React.FC = () => {
  ...
  return (
    <section className='relative md:mt-0'>
      <button className='absolute left-1 md:-left-[40px] 2xl:-left-[39.7px] top-1/2 -translate-y-1/2 md:ml-[0.3rem] w-9 h-9 rounded-full md:rounded-r-none border border-customBlue-300 bg-customGray-300 flex items-center justify-center scale-90 md:scale-100 hover:bg-secondary-900 active:bg-customGray-300'
